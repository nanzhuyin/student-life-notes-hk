...
const categories: CategoryMeta[] = [
  {
    key: 'housing',
    name: '租房',
    description: '预算、看房、合租和入住检查',
    accent: 'warm'
  },
  {
    key: 'commute',
    name: '通勤',
    description: '口岸、跨境、夜间回程和备用路线',
    accent: 'green'
  },
  {
    key: 'food',
    name: '饮食',
    description: '茶餐厅、超市、街市和日常吃饭',
    accent: 'orange'
  },
  {
    key: 'travel',
    name: '出行',
    description: '机场、高铁、地铁、巴士和周末探索',
    accent: 'blue'
  },
  {
    key: 'adaptation',
    name: '生活适应',
    description: '天气、电话卡、支付和城市生活',
    accent: 'mint'
  },
  {
    key: 'hk-life',
    name: '港漂经验',
    description: '来港准备、节奏调整和实用清单',
    accent: 'peach'
  }
];
