...
港伴记是一个非官方、个人/学生自发维护的香港学习生活信息网站。v1.09 支持邮箱注册、服务端访问统计、投稿建议处理，以及两个学校平台的课程库、收藏和生活内容。
...
- 品牌名：港伴记，不使用任何学校名称作为产品名。
- 用户注册：邮箱 + 用户名 + 学校选择，不发送验证码。
...
- 管理视角：管理员账号 + 强密码登录，支持查看服务端总浏览量、EDU / LU 浏览量、停留时间、功能打开排行、最近事件和注册用户。
- 投稿建议：底部支持窗口可提交投稿、建议、纠错和合作信息，用户需填写任意联系方式，推荐邮箱。
- 工单处理：管理端可查看投稿建议，并标记为处理中、已处理或关闭。
